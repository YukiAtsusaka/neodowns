#' Perform computer simulations of candidate behavior (previous version)
#'
#' @description `neodowns_prev()` simulates the changes in candidate positions under three electoral strategies.
#'
